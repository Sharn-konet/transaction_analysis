...
While experimenting with different models in the ARIMA family, I would also investigate integrating a seasonal component through a SARIMA model. Seasonality is common in financial data (higher sales during certain periods), and is clearly present in this data, as shown in the "Weighted Average of Monthly Sale Price" plot above.
...
I'm confident in the forecast, however, I do think there's a significant amount of uncertainty associated with it due to a lack of past data. It seems inline with the trend, I'd expect the data to take. Although admittedly, I do not see the spike in June which was apparent from the "Weighted Mean Plot" so it might be worth investigating this given more time.
